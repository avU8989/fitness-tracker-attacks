# A1 - BLE Injection 
# Attack 1 (Unprotected App Layer, Protected BLE Layer - Enforced LE Secure Connection, Encrypted/Authenticated Write/Read Requests) #
...
BlueZ does not allow having multiple simultaneous adverts that both specify LocalName - even if they are on different adapters
My thought was having both hci0 (Real Peripheral) and hci1 (Fake Peripheral) their name set to "Secured FitTrack" to confuse the app
