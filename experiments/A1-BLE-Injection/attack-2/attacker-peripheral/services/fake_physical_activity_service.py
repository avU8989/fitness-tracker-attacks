...
class FakePhysicalActivityService(Service):
    def __init__(self,
                 initial_steps: int = 0,
    ...
    @characteristic(STEP_COUNTER_MEASUREMENT, CF.READ)
    def step_counter(self, opts):
        """Return payload for read request"""
    ...
    async def control(self):
        ...
        print("[Physical Activity Monitor Control] Type 'help' for commands")

        while True:
            line = await loop.run_in_executor(None, input, "PAMS> ")
