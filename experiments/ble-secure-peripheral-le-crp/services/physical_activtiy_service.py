...
class PhysicalActivityMonitorService(Service):
    def __init__(self,
                 initial_steps: int = 0,
    ...
    @characteristic(STEP_COUNTER_MEASUREMENT, flags=CF.NOTIFY | CF.AUTHENTICATED_SIGNED_WRITES | CF.ENCRYPT_AUTHENTICATED_READ | CF.ENCRYPT_AUTHENTICATED_WRITE)
